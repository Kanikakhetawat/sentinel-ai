...
public class DebuggingAgentTest {
    ...
    private static final String AUTH_HEADER =
            "O-Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJpZGVudGl0eU1hbmFnZXIiLCJ2ZXJzaW9uIjoiNC4wIiwidGlkIjoiNTE1YTY0ODYtZjQ5Yy00OTEyLWI4M2QtZTQzYzNmYmU0ZWUwIiwic2lkIjoiZjQ4ODJjMmMtNGM5MC00MWQzLWI2NjUtYjY3ZmZjZDViMzFmIiwiaWF0IjoxNzQ1NDY3NTA1LCJleHAiOjE3NDU1NTM5MDV9.yF4yErP-0d2UgCdYvJyBfwpWhvJh49OzO6czNcbCzbo4fo_gsY4kY6LamFfLM6XLtkJBlCJ5HXe_hLy0vKYBRg";
    private static final String STAGE_AUTH_HEADER =
            "O-Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJpZGVudGl0eU1hbmFnZXIiLCJ2ZXJzaW9uIjoiNC4wIiwidGlkIjoiM2EyNDBkNzQtMmI2NC00YWY3LWEzMDYtMjFhYjU2YzI2NjcxIiwic2lkIjoiNmMyOWU1ZjMtODNhNS00YTcxLWJjYWYtNjRiMTFhN2NkNDExIiwiaWF0IjoxNzQ1NDY3NTc1LCJleHAiOjE3NDYwNzIzNzV9.1REArEM6JgeoGUqAKovuysKnIwkB32kc4vCjJt-t7tWTy8M8Vu8MrDq3SSRReaMFtULvp1-09lb8UhPrdNZi9g";
    ...
    private static final class TestAgent extends Agent<UserInput, String, TestAgent> {
        ...
        @Builder
        public TestAgent(@NonNull AgentSetup agentSetup, List<AgentExtension> extensions, Map<String, CallableTool> tools) {
            super(String.class,
                    """
    ...
    void test() {
        ...
        final var response = agent.execute(new UserInput("""
                Why is payments elapsed time high
                """, "payment",
                1745205600000L, 1745206082000L), requestMetadata, null, null);
